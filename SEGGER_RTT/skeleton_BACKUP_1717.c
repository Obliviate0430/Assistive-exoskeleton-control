	...
	switch(current) 
	{
        ...
        case LeftAssistance:
            if(input == LeftFlag) {
				...
				Fd_Left=0;
				ClearError();
				StiffOffset_left();//当前步态周期结束或切换后，更新误差
...
<<<<<<< HEAD
//		 if (RCycletick>=1000)//测试定时器，无实际助力
=======
//		 if (RCycletick>=1500)//测试定时器，无实际助力
>>>>>>> 8a42b095f72058eb19149affaac9b7dc078fb65f
//		 {
//		 	input=RightFlag;
//			
...
//		}
<<<<<<< HEAD
//		 if (LCycletick>=1000)//测试定时器，无实际助力
=======
...
//			
//		}
		motor_position_real=motor_data.motor_pos;
