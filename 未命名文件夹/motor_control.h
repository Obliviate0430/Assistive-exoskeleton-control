...
typedef struct
{
    ...
    unsigned short mode;                // 0:空闲, 5:``````````````````````````````, 10:闭环FOC控制
    //实际给FOC的指令力矩为：
    // K_P*delta_Pos + K_W*delta_W + T
...
extern void motor_profileVelocity(int i, float vel_rad);
extern void motor_profilePosition(int i, float pos_rad);
extern void motor_damping(int i);
extern void motor_zeroTorque(int i);
extern void motor_Torque(int i,float torque);
extern void motor_stop(int i);
extern void motor_init(int i);
extern void motor_getinfo(void);
#endif
